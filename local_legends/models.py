...
class Restaurants(db.Model):
    ...
    restaurant_average_taste_stars = db.Column(db.Float, nullable=False)
    restaurant_average_presentation_stars = db.Column(db.Float, nullable=False)
    restaurant_average_friendliness_stars = db.Column(db.Float, nullable=False)
    restaurant_average_price_stars = db.Column(db.Float, nullable=False)
    restaurant_average_ambience_stars = db.Column(db.Float, nullable=False)
    restaurant_average_overall_stars = db.Column(db.Float, nullable=False)
